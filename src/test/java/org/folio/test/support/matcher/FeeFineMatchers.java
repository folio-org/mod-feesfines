...
public final class FeeFineMatchers {
  ...
  public static Matcher<?> hasAllAutomaticFeeFineTypesFor15_10() {
    return hasJsonPath("feefines", allOf(iterableWithSize(6),
      hasItems(
        allOf(
  ...
  @SuppressWarnings("all")
  public static Matcher<?> hasAllAutomaticFeeFineTypesFor18_3() {
    return hasJsonPath("feefines", allOf(iterableWithSize(6),
      hasItems(
        allOf(
          hasJsonPath("id", is("9523cb96-e752-40c2-89da-60f3961a488d")),
        ...
        allOf(
          ...
          hasJsonPath("feeFineType", is("Lost item fee (actual cost)"))),
        allOf(
          hasJsonPath("id", is("6b830703-f828-4e38-a0bb-ee81deacbd03")),
          hasJsonPath("automatic", is(true)),
          hasJsonPath("feeFineType", is("Reminder fee")))
      )));
  }
}
