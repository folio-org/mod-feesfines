...
public class TransfersAPI implements Transfers {
  ...
  private final Logger logger = LogManager.getLogger(TransfersAPI.class);
              ...
              try {
                if (reply.succeeded()) {
                  ...
                  postgresClient.endTx(beginTx, done
                    ...
                    Future.succeededFuture(PostTransfersResponse.respond201WithApplicationJson(transfer,
  ...
  public void putTransfersByTransferId(String transferId, Transfer entity,
    ...
    try {
      if (transferId == null) {
        ...
        asyncResultHandler.handle(
          Future.succeededFuture(PutTransfersByTransferIdResponse.respond400WithTextPlain("transferId is missing")));
      }
