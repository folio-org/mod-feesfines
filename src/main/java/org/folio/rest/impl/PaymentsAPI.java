...
public class PaymentsAPI implements Payments {
  ...
  private final Logger logger = LogManager.getLogger(PaymentsAPI.class);
              ...
              try {
                if (reply.succeeded()) {
                  ...
                  postgresClient.endTx(beginTx, done
                    ...
                    Future.succeededFuture(PostPaymentsResponse.respond201WithApplicationJson(payment,
  ...
  public void putPaymentsByPaymentId(String paymentId, Payment entity,
    ...
    try {
      if (paymentId == null) {
        ...
        asyncResultHandler.handle(
          Future.succeededFuture(PutPaymentsByPaymentIdResponse.respond400WithTextPlain("paymentId is missing")));
      }
